...
class FinancialStatus(BaseModel):
    ...
    income_range: str | None = Field(None, description="e.g. '5-10L', '10-25L', '25L+'")
    existing_investments: bool | None = Field(
        None, description="Has any existing investment"
    )
    debt_obligations: bool | None = Field(None, description="Has active EMIs / debt")
    emergency_fund: bool | None = Field(
        None, description="Has 3-6 month emergency fund"
    )
...
class OnboardingRequest(BaseModel):
    ...
    asset_preferences: list[str] | None = Field(
        None,
    ...
    @classmethod
    def validate_risk(cls, v: str | None) -> str:
